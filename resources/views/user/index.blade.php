          ...
          <div class="modal-body">
                <form class="row g-3" id="addcandidate" action="{{route('user/index')}}" method="post">
                  ...
                  <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="place_of_birth" name="place_of_birth" placeholder="Apartment, studio, or floor">
                  </div>
                  <div class="col-12">
                  ...
                  <div class="col-md-3">
                    ...
                    <input type="number" class="form-control" id="police_licence" name="police_licence">
                  </div>
                  <div class="col-md-3">
                    <label for="inputZip" class="form-label">Driving Licence</label>
                    <input type="number" class="form-control" id="driving_licence" name="driving_licence">
                  </div>
